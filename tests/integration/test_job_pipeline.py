...
def test_job_pipeline_runs_end_to_end_in_memory(
    ...
    assert queued_job.output_file == "output/user/guest/job/job-1/input.md"
    assert fake_storage_port.objects["output/user/guest/job/job-1/input.md"] == b"goodbye world"
